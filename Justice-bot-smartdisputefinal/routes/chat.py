...
from services.canlii_search import get_relevant_cases  # curated fallback
from services.timeline_builder import generate_timeline  # new!
...
def chat():
    try:
        ...
        # Step 5: Generate legal timeline
        timeline = generate_timeline(session["case_profile"])
